...
/**
 * 这是一个viewGroup容器，实现上下两个frameLayout拖动切换,类似于淘宝中的商品页效果
 * 用法
 * 1:布局
 *   <cn.chamatou.lib.widget.VertslideLayout
 ...
 */
@SuppressLint("NewApi")
public class VertslideLayout extends ViewGroup{
	/* 拖拽工具类 */
	...
	public VertslideLayout(Context context) {
		this(context, null);
	}

	public VertslideLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public VertslideLayout(Context context, AttributeSet attrs, int defStyle) {
