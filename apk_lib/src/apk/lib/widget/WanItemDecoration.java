...
public class WanItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + OSUtils.dip2px(parent.getContext(), leftMargin);
        final int right = parent.getWidth() - parent.getPaddingRight() - OSUtils.dip2px(parent.getContext(), rightMargit);
