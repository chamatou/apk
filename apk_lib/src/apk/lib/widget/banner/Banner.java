...
import apk.lib.widget.banner.transformer.AccordionPageTransformer;
import apk.lib.widget.banner.transformer.AlphaPageTransformer;
import apk.lib.widget.banner.transformer.CubePageTransformer;
import apk.lib.widget.banner.transformer.DefaultPageTransformer;
import apk.lib.widget.banner.transformer.DepthPageTransformer;
import apk.lib.widget.banner.transformer.FadePageTransformer;
import apk.lib.widget.banner.transformer.FlipPageTransformer;
import apk.lib.widget.banner.transformer.RotatePageTransformer;
import apk.lib.widget.banner.transformer.StackPageTransformer;
import apk.lib.widget.banner.transformer.ZoomCenterPageTransformer;
import apk.lib.widget.banner.transformer.ZoomFadePageTransformer;
import apk.lib.widget.banner.transformer.ZoomPageTransformer;
import apk.lib.widget.banner.transformer.ZoomStackPageTransformer;
import apk.lib.R;
...
public class Banner extends RelativeLayout {
    ...
    private final class ChangePointListener extends BannerViewPager.SimpleOnPageChangeListener {
